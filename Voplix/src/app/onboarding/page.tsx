...
export default function OnboardingPage() {
  ...
  const [validatedBot, setValidatedBot] = useState<{ username: string } | null>(
    null,
  );
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-100 p-4">
      <div className="w-full max-w-md">
        <Link
          href="/dashboard"
          className="mb-4 inline-flex items-center gap-2 text-sm font-medium text-zinc-700 outline-none ring-offset-2 hover:text-zinc-900 focus-visible:ring-2 focus-visible:ring-indigo-500"
        >
          <ArrowLeft className="h-4 w-4 shrink-0" aria-hidden />
          {t("Back to dashboard")}
        </Link>
        <Card className="w-full border-zinc-200 bg-white">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-zinc-600">
              Enter your Telegram bot token to get started. You can get this
              from @BotFather.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-xs text-zinc-500">
                Your token is encrypted and never exposed. Format:
                numbers:letters
              </p>
            </div>
            ...
            <div className="flex gap-2">
              <Button
                ...
                disabled={
                  !token.trim() || validating || loading || !!validatedBot
                }
                variant="outline"
                className="flex-1 border-zinc-300 text-zinc-700 hover:bg-zinc-300"
              >
                {validating ? (
                  <>
            ...
            <div className="rounded-lg bg-zinc-200 p-4 space-y-2">
