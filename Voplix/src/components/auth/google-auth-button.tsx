...
export function GoogleAuthButton({ label = 'Continue with Google' }: { label?: string }) {
  ...
  return (
    <Button
      type="button"
      variant="outline"
      className="w-full border-zinc-300 bg-white text-zinc-900 hover:bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700/80"
